...
export const promptyBranzowe: Material = {
  ...
  metaTitle: 'Prompty AI: kancelaria, e-commerce, budowlanka',
  metaDescription:
  ...
  tresc: [
    {
      typ: 'akapit',
      tekst: 'Ogólne prompty dają ogólne wyniki. Te są dopasowane do trzech branż: kancelaria prawna, e-commerce i budowlanka. Każdy rozwiązuje realne zadanie z danej branży. Skopiuj prompt, podmień to, co jest w [nawiasach], na swoje dane i wklej do ChatGPT, Claude albo Gemini.',
    },
    {
      typ: 'cytat',
      tekst: 'Im bliżej Twojej branży jest prompt, tym mniej poprawiasz po AI. Branżowy kontekst robi połowę roboty.',
    },
    {
      typ: 'tabela',
      naglowki: [
      ...
      wiersze: [
        [
          'Prompty dla kancelarii prawnej',
          '6 promptów',
        ],
        [
          'Prompty dla e-commerce',
          '7 promptów',
        ],
        [
          'Prompty dla branży budowlanej',
          '7 promptów',
        ],
      ],
      wKarcie: true,
      podpis: 'Co znajdziesz w tym materiale: 20 promptów dla 3 branż',
    },
    {
      typ: 'sekcja',
      naglowek: 'Prompty dla kancelarii prawnej',
      akapity: [
    ...
    {
      typ: 'sekcja',
      naglowek: 'Prompty dla e-commerce',
      akapity: [
    ...
    {
      typ: 'sekcja',
      naglowek: 'Prompty dla branży budowlanej',
      akapity: [
    ...
    {
      typ: 'sekcja',
      naglowek: 'Twojej branży nie ma na liście?',
      akapity: [
  ...
  powiazanePoradniki: [
    {
      etykieta: 'AI w biurze rachunkowym: które procesy zautomatyzować',
      href: '/poradniki/ai-w-biurze-rachunkowym-jakie-procesy-zautomatyzowac',
      opis:
        'Lista 12 procesów w usługowej firmie i kolejność, w jakiej warto je brać.',
    },
  ],
