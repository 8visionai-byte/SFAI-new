...
/**
 * MAGNET 4 — „10 błędów przy wdrażaniu AI w firmie (i jak ich uniknąć)".
 *
 * Realna, użyteczna treść: 10 najczęstszych błędów MŚP, przy każdym jak go poznać
 * i co zrobić zamiast tego (antidotum). Pełna treść w HTML (cytowalna), PDF to
 * bonus, nie bramka. Przycisk pobrania = STUB (TODO Make/PDF). Linkuje do #diagnoza.
 */
export const dziesiecBledow: Material = {
  slug: '10-bledow-przy-wdrazaniu-ai-w-firmie',
  tytul: '10 błędów przy wdrażaniu AI w firmie, i jak ich uniknąć',
  etykieta: 'Poradnik',
  typPliku: 'PDF',
  ctaPobierz: 'Pobierz listę błędów (PDF)',
  opis:
  ...
  faq: [
    {
      pytanie: 'Jaki jest najczęstszy błąd przy wdrażaniu AI w firmie?',
      odpowiedz:
        'Zaczynanie od narzędzia zamiast od problemu. Firma mówi „chcemy chatbota" albo „wdróżmy AI", zanim wie, który problem ma to rozwiązać. Narzędzie bez konkretnego problemu to wydatek bez zwrotu. Zacznij od pytania, co zżera najwięcej czasu, i dopiero do tego dobierz rozwiązanie.',
    },
    {
      pytanie: 'Czy AI musi mieć 100% dokładności, żeby się opłacało?',
      odpowiedz:
        'Nie. Cel wdrożenia to realnie odzyskany czas, a nie zero pomyłek. Dobre rozwiązanie testujesz najpierw na małej próbce, poprawiasz i dopiero potem skalujesz, a człowiek pilnuje wyjątków. Nawet gdy AI przygotuje wynik z drobną korektą, i tak oszczędzasz większość czasu w porównaniu z robotą od zera.',
    },
    {
