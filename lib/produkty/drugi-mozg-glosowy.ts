 ...
 *    ma własny interfejs, uczy się JEDNEJ osoby i ma cenę 7999 zł netto).
 *
...
export const drugiMozgGlosowy: Produkt = {
  ...
  customNote:
    'To punkt wyjścia do customu. Bazę wiedzy budujemy na Twoich materiałach, a skład wirtualnego zespołu dobieramy do tego, czym się zajmujesz. Zakres i wycenę ustalamy na bezpłatnej diagnozie.',
