    ...
    <Section tone="base" space="lg" seam className="overflow-x-clip">
      ...
      <Reveal delay={0.1}>
        <p className="mx-auto mt-6 max-w-narrow text-caption text-fg-subtle">
          ...
          cokolwiek zamówisz. Bez ukrytych kosztów. Po wdrożeniu albo przekazujemy Ci infrastrukturę i nie płacisz abonamentu, albo zostaje u nas pod opieką: 99-599 zł netto miesięcznie przy chatbotach i automatyzacjach, 299 do 1500 zł netto przy voicebotach.
        </p>
      </Reveal>
