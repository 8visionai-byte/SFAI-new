/**
 * Barrel — sekcje strony /o-nas (E-E-A-T, dwóch founderów).
 * Import: import { OnasHero, OnasHistoria, ... } from '@/components/o-nas';
 */
...
export { OnasWartosci } from './OnasWartosci';
export { OnasCTA } from './OnasCTA';
