...
export default async function PodstronaOptymalizacjiPage({ params }: { params: Promise<Params> }) {
  ...
  // Rodzic „optymalizacja" ma w mapie tamtego modułu etykietę „Optymalizacja",
  // więc łańcuch ma 4 poziomy (Strona główna / Usługi / Optymalizacja / H1) —
  // TAK SAMO w widoku i w JSON-LD, bo obie warstwy biorą tę samą tablicę.
